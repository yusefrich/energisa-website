...
<?php $img_background = get_the_post_thumbnail_url(null, 'full'); ?>
            ...
            <div class="row  py-5 mr-2">
                ...
                <div class="col-md-6">
                    <div class="product-description-text pl-3">
                        ...
                        <p data-aos="fade-up">Lorem Ipsum é simplesmente uma simulação de texto da indústria tipográfica
                            e de impressos, e
    ...
    <section id="product-timeline">
        <div data-aos="fade-up" class="container pt-5">
            ...
            <p class="text-gray">Acompanhe através da nossa linha do tempo as principais etapas deste projeto e veja o
        ...
        <div class="container">
            ...
            <div class="row mt-5">
                <div data-aos="fade-right" class="col-md-4">
                    <img src="<?php bloginfo('template_url'); ?>/img/ultimas-not-1.png" class="figure-img img-fluid rounded zoom-hover" alt="...">
                    <p class="img-caption  text-uppercase">
                        <small>postado em <strong> 05 de Jan 2020 </strong></small>
                    </p>
                    <p class="font-weight-bold">Ao contrário do que se acredita, Lorem Ipsum não é simplesmente um texto
                        randômico</p>
                    <p class="font-weight-light">Se popularizou na década de 60, quando a Letraset lançou decalques
                        contendo passagens de Lorem Ipsum</p>
                </div>
                <div data-aos="fade-left" class="col-md-4">
                    <img src="<?php bloginfo('template_url'); ?>/img/ultimas-not-2.png" class="figure-img img-fluid rounded zoom-hover" alt="...">
                    <p class="img-caption  text-uppercase">
                        <small>postado em <strong> 05 de Jan 2020 </strong></small>
                    </p>
                    <p class="font-weight-bold">Ao contrário do que se acredita, Lorem Ipsum não é simplesmente um texto
                ...
                <div data-aos="fade-right" class="col-md-4">
                    <img src="<?php bloginfo('template_url'); ?>/img/ultimas-not-3.png" class="figure-img img-fluid rounded zoom-hover" alt="...">
                    <p class="img-caption  text-uppercase">
                        <small>postado em <strong> 05 de Jan 2020 </strong></small>
                    </p>
                    <p class="font-weight-bold">Ao contrário do que se acredita, Lorem Ipsum não é simplesmente um texto
