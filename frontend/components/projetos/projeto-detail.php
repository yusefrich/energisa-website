<section id="projeto-detail">
    <div class="container">
        <div id="parallax-detalhe-2">
            <div data-depth="0.2" class="d-flex justify-content-between">
                <div style="z-index: 1;" class="trace-detail-left trace-detail-offset-bottom">
                    <img class="" src="./img/detalhes-traco-laranja.png" alt="">
                </div>
        ...
        <div data-aos="fade-up" class="row my-5 py-5 ">
            ...
            <div class="col-md-7">
                <p class="text-caption text-dark">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In faucibus
                    aenean amet integer augue neque. At urna scelerisque blandit duis consequat eu purus. Commodo
                    tellus, enim diam et vitae aliquet fusce. Purus ullamcorper proin convallis feugiat in nec
                    scelerisque ac.</p>
            </div>
        </div>
        <div data-aos="fade-up" class="row my-5 py-5">
            <div class="col-md-6">
                <div style="max-width: 400px">
                    ...
                    <p class="font-weight-normal">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In faucibus
                        aenean amet integer augue neque. At urna scelerisque blandit duis consequat eu purus.</p>
                </div>
            </div>
            <div class="col-md-6">
                <div style="max-width: 400px">
        ...
        <div data-aos="fade-left" class="row mb-5 mt-2">
            <div class="col-md-6 text-center mb-3">
                <div class="white-col p-3">
                    ...
                    <p class="text-gray"><small>Lorem ipsum dolor sit amet, consectetur adipiscing</small></p>
                    <div class="d-flex justify-content-start p-3">
                        <div>
                            <canvas width="270" height="270" id="chart2"></canvas>
                        </div>
                        <div class="labels text-left">
                            <p class="text-gray font-weight-light"><small>Legendas</small></p>
                            <p><span class="label-dot" style="color: #0071A2">&#149;</span><small> Cor Azul
                                    Escuro</small></p>
                            <p><span class="label-dot" style="color: #70BF54">&#149;</span><small> Cor Verde</small></p>
                            <p><span class="label-dot" style="color: #089BC0">&#149;</span><small> Cor Azul
                                    Claro</small></p>
                        </div>
...
<section id="como-estamos-projeto">
    <div class="container">
        <div class="text-center mt-5 py-5">
            ...
            <p style="max-width: 620px" class="text-gray m-auto">Acompanhe através da nossa linha do tempo as principais
    ...
    <div class="container-fluid p-0">
        <div data-aos="fade-left" class="timeline">
            <ol>
                <li>
                    <div>
                        <p class="text-gray text-uppercase float-left mr-2"><small>15 de dez 2019</small></p>
                        <span class="orange-outline-text py-1 px-2 mr-2 ">Aprovação</span>

                        <p class="text-caption font-weight-bold">Funcionalidade de pagamento</p>
                        <p class="text-gray"><small>Lorem Ipsum é simplesmente uma simulação de texto da indústria
                                tipográfica e de impressos</small></p>
                        <div class="d-flex justify-content-start">
                            <p class="pt-1 pr-3"><small>ANDAMENTO</small></p>
                            <div class="p-0 timeline-progress-circle" id="como-estamos-graph-1"></div>
                            <p style="left: -40px; top: 8px; position: relative;"><small class="font-weight-bold">58%</small></p>
                        </div>
                    </div>
                </li>
                <li>
                    <div>
                        ...
                        <div class="d-flex justify-content-start">
                            <p class="pt-1 pr-3"><small>ANDAMENTO</small></p>
                            <div class="p-0 timeline-progress-circle" id="como-estamos-graph-2"></div>
                            <p style="left: -40px; top: 8px; position: relative;"><small class="font-weight-bold">58%</small></p>
                        </div>
                    </div>
                </li>
                <li>
                    <div>
                        ...
                        <p class="text-caption font-weight-bold text-blue">Funcionalidade de pagamento</p>
                        <p class="text-gray"><small>Lorem Ipsum é simplesmente uma simulação de texto da indústria
                                tipográfica e de impressos</small></p>
                        <div class="d-flex justify-content-start">
                            <p class="pt-1 pr-3"><small>ANDAMENTO</small></p>
                            <div class="p-0 timeline-progress-circle" id="como-estamos-graph-3"></div>
                            <p style="left: -40px; top: 8px; position: relative;"><small class="font-weight-bold">58%</small></p>
                        </div>
                    </div>
                </li>
                <li>
                    <div>
                        ...
                        <div class="d-flex justify-content-start">
                            <p class="pt-1 pr-3"><small>ANDAMENTO</small></p>
                            <div class="p-0 timeline-progress-circle" id="como-estamos-graph-4"></div>
                            <p style="left: -40px; top: 8px; position: relative;"><small class="font-weight-bold">58%</small></p>
                        </div>
                    </div>
                </li>
