        ...
        <div class="container">
            <div id="parallax-detalhe-1">
                <div data-depth="0.2" class="d-flex justify-content-between" >
                    <div   class="trace-detail-left " >
                                <img class="" src="./img/detalhes-traco-branco.png" alt="">
                    </div>
            ...
            <div class="row mt-5">
                ...
                <div data-aos="fade-right" class="col-md-6">
                    <img src="./img/n-small-1.png" class="figure-img img-fluid rounded zoom-hover" alt="...">
                    <p class="img-caption text-white"><strong> Ao contrário do que se acredita, Lorem Ipsum não é simplesmente um texto randômico </strong> </p>
                </div>
                <div data-aos="fade-left" class="col-md-6">
                    <img src="./img/n-small-2.png" class="figure-img img-fluid rounded zoom-hover" alt="...">
                    <p class="img-caption text-white"><strong> Ao contrário do que se acredita, Lorem Ipsum não é simplesmente um texto randômico</strong> </p class="text-white">
                </div>
                <div data-aos="fade-right" class="col-md-6">
                    <img src="./img/n-small-3.png" class="figure-img img-fluid rounded zoom-hover" alt="...">
                    <p class="img-caption text-white"><strong> Ao contrário do que se acredita, Lorem Ipsum não é simplesmente um texto randômico</strong> </p class="text-white">
                </div>
                <div data-aos="fade-left" class="col-md-6">
                    <img src="./img/n-small-4.png" class="figure-img img-fluid rounded zoom-hover" alt="...">
                    <p class="img-caption text-white"><strong> Ao contrário do que se acredita, Lorem Ipsum não é simplesmente um texto randômico</strong> </p class="text-white">
                </div>
                <div class="col-12">
