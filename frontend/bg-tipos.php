                        ...
                        <div class="slider-title ">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div style="
                                height: 431px;
                                background-image: url(./img/product-info-full.png);
...
<section class="bg-white">
    <div class="container-fluid p-0">
        ...
        <div id="carrouselProdutosWhite" class="carousel slide" data-ride="carousel">
            <!-- carousel-fade -->
            ...
            <div class="container">
                ...
                <div class="custom-control-carrousel-center custom-control-bottom">
                    ...
                    <a href="#carrouselProdutosWhite" role="button" data-slide="prev"
                        class="btn btn-primary btn-round"><span class="icon pt-2 pb-2 pl-1 icon-prev-icon"></span></a>
                    <a href="#carrouselProdutosWhite" role="button" data-slide="next"
...
<section class="bg-gray">
    <div class="container-fluid p-0">
        ...
        <div id="carrouselProdutosGray" class="carousel slide" data-ride="carousel">
            <!-- carousel-fade -->
            ...
            <div class="container">
                ...
                <div class="custom-control-carrousel-center custom-control-bottom">
                    ...
                    <a href="#carrouselProdutosGray" role="button" data-slide="prev"
                        class="btn btn-primary btn-round"><span class="icon pt-2 pb-2 pl-1 icon-prev-icon"></span></a>
                    <a href="#carrouselProdutosGray" role="button" data-slide="next"
                        class="btn btn-primary btn-round"><span class="icon pt-2 pb-2 pr-1 icon-next-icon"></span></a>
                </div>
            </div>
